...
module.exports =
{
  ...
  "HauntedWoods": {
    ...
    "types": "Action - Attack - Duration",
    "cost": "$5",
    "text": "Until your next turn, when any other player buys a card, they puts their hand onto their deck in any order. At the start of your next turn:\r\n+3 Cards",
  },
  "Hero": {
    "name": "Hero",
    "set": "Adventures",
  ...
  "Warrior": {
    ...
    "types": "Action - Attack - Traveller",
    "cost": "$4*",
    "text": "+2 Cards\r\nOnce per Traveller you have in play (including this), each other player discards the top card of ther deck and trashes it if it costs $3 or $4.\r\nWhen you discard this from play, you may exchange it for a Hero.\r\n(This is not in the Supply.)",
  },
  "WineMerchant": {
    "name": "Wine Merchant",
    "set": "Adventures",
  ...
  "Jester": {
    ...
    "types": "Action - Attack",
    "cost": "$5",
    "text": "+$2\r\nEach other player discards the top card of their deck. If it’s a Victory card they gains a Curse; otherwise they gain a copy of the discarded card or you do, your choice.",
  },
  "Menagerie": {
    "name": "Menagerie",
    "set": "Cornucopia",
  ...
  "Aqueduct": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When you gain a Treasure, move 1 VP from its pile to this. When you gain a Victory card, take the VP from this.\r\nSetup: Put 8 VP on the Silver and Gold piles.",
  },
  "Archive": {
    "name": "Archive",
    "set": "Empires",
  ...
  "Basilica": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When you buy a card, if you have $2 or more left, take 2 VP from here.\r\nSetup: Put 6 VP here per player.",
  },
  "Baths": {
    "name": "Baths",
    "set": "Empires",
    "types": "Landmark",
    "cost": "",
    "text": "When you end your turn without having gained a card, take 2 VP from here.\r\nSetup: Put 6 VP here per player.",
  },
  "Battlefield": {
    "name": "Battlefield",
    "set": "Empires",
    "types": "Landmark",
    "cost": "",
    "text": "When you gain a Victory card, take 2 VP from here.\r\nSetup: Put 6 VP here per player.",
  },
  "BustlingVillage": {
  ...
  "Colonnade": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When you buy an Action card, if you have a copy of it in play, take 2 VP from here.\r\nSetup: Put 6 VP here per player.",
  },
  "Conquest": {
    "name": "Conquest",
    "set": "Empires",
  ...
  "DefiledShrine": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When you gain an Action, move 1 VP from its pile to this. When you buy a Curse, take the VP from this.\r\nSetup: Put 2 VP on each non-Gathering Action Supply pile.",
  },
  "Delve": {
    "name": "Delve",
    "set": "Empires",
  ...
  "Keep": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When scoring, 5 VP per differently named Treasure you have, that you have more copies of than each other player, or tied for most.",
  },
  "KingsCastle": {
    "name": "King's Castle",
    "set": "Empires",
    "types": "Victory - Castle",
    "cost": "$10",
    "text": "Worth 4 VP per Castle you have.",
  },
  "Labyrinth": {
    "name": "Labyrinth",
    "set": "Empires",
    "types": "Landmark",
    "cost": "",
    "text": "When you gain a 2nd card in one of your turns, take 2 VP from here.\r\nSetup: Put 6 VP here per player.",
  },
  "Legionary": {
    "name": "Legionary",
    "set": "Empires",
  ...
  "MountainPass": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When you are the first player to gain a Province, after that turn, each player bids once, up to 40 D, ending with you. High bidder gets +8 VP and takes the Dthey bid.",
  },
  "Museum": {
    "name": "Museum",
    "set": "Empires",
  ...
  "Obelisk": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When scoring, 2 VP per card you have from the chosen pile.\r\nSetup: Choose a random Action Supply pile.",
  },
  "OpulentCastle": {
    "name": "Opulent Castle",
    "set": "Empires",
  ...
  "Overlord": {
    ...
    "types": "Action",
    "cost": "8 D",
    "text": "Play this as if it were an Action card in the Supply costing up to $5. This is that card until it leaves play.",
  },
  "Palace": {
    "name": "Palace",
    "set": "Empires",
    "types": "Landmark",
    "cost": "",
    "text": "When scoring, 3 VP per set you have of Copper - Silver - Gold.",
  },
  "Patrician": {
    "name": "Patrician",
    "set": "Empires",
  ...
  "Ritual": {
    ...
    "types": "Event",
    "cost": "$4",
    "text": "Gain a Curse. If you do, trash a card from your hand. +1 VP per $1 it cost.",
  },
  "Rocks": {
    "name": "Rocks",
    "set": "Empires",
  ...
  "TriumphalArch": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When scoring, 3 VP per copy you have of the 2nd most common Action card among your cards (if it’s a tie, count either).",
  },
  "Villa": {
    "name": "Villa",
    "set": "Empires",
  ...
  "WolfDen": {
    ...
    "types": "Landmark",
    "cost": "",
    "text": "When scoring, -3 VP per card you have exactly one copy of.",
  },
  "Advisor": {
    "name": "Advisor",
    "set": "Guilds",
  ...
  "Baker": {
    ...
    "types": "Action",
    "cost": "$5",
    "text": "+1 Card\r\n+1 Action\r\n+1 Coffers\r\nSetup: Each player get +1 Coffers.",
  },
  "Butcher": {
    "name": "Butcher",
    "set": "Guilds",
  ...
  "SilkRoad": {
    ...
    "types": "Victory",
    "cost": "$4",
    "text": "Worth 1 VP for every 4 Victory cards you have (round down).",
  },
  "SpiceMerchant": {
    "name": "Spice Merchant",
    "set": "Hinterlands",
    "types": "Action",
    "cost": "$4",
    "text": "You may trash a Treasure from your hand to choose one:\r\n+2 Cards and +1 Action; or +1 Buy and +$2.",
  },
  "Stables": {
    "name": "Stables",
    "set": "Hinterlands",
  ...
  "Avanto": {
    ...
    "types": "Action",
    "cost": "$5",
    "text": "+3 Cards\r\nYou may play an Sauna from your hand.",
  },
  "BlackMarket": {
    "name": "Black Market",
    "set": "Promo",
